...
- Package gates: SDK, server, and UI typecheck and lint passed. The four FORM-6 locale additions are present in en/de/ja/zh; i18n reports no extra-key or placeholder mismatch in any locale (the repository's existing untranslated-key baseline remains de 677, ja 681, zh 681).
