...
describe('toHtmlSite', () => {
  ...
  it('renders an inline/hosted database as a table of navigable rows', () => {
    ...
    // The tag inlines the canonical pastel green chip colours (OB-378), matching
    // the in-app SelectChip — not the old fill@20%-alpha wash.
    expect(html).toContain('style="background:#bbf7d0;color:#166534">Done</span>');
  });
