/**
 * Single-source kit-chart renderer. This file is both imported as ordinary JS
 * for the static export and read through Vite's `?raw` suffix for the standalone
 * page runtime. Keep it dependency-free: the raw form is emitted verbatim.
 */
...
/** Draw one kit chart using an explicit, already-resolved series palette. */
export function drawKit(v,kind,labels,palette){
  labels = labels || [];
  const W=660,H=300,PAD=34,P=palette;
