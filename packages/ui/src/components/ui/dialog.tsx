...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-hover data-[state=open]:text-muted-foreground">
