    ...
    <div className="flex flex-col gap-1.5">
      ...
      {selected === CUSTOM && (
        <input
          ...
          spellCheck={false}
          className="w-full rounded-md border border-border bg-card px-2 py-1.5 text-sm outline-hidden transition-[color,border-color,box-shadow] focus-visible:border-ring focus-visible:shadow-[var(--ring-field)]"
        />
      )}
    </div>
  );
