...
export const en = {
  ...
  agentEdits: {
    ...
    modeHint: 'Suggest keeps a human in the loop — every agent change waits as a suggestion for you to accept or reject. Direct lets MCP clients and the built-in AI edit pages immediately, with no suggestion step; the edits are attributed in the page’s history, and any page can override this default.',
