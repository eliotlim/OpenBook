...
export const en = {
  ...
  importer: {
    ...
    imagesNote: '{count} images come in as placeholders for now — they keep their link, and a later update can store them.',
    imagesNoteOne: '{count} image comes in as a placeholder for now — it keeps its link, and a later update can store it.',
    back: 'Back',
    import: 'Import',
    ...
    imagesResult: '{count} images were imported as placeholders.',
    imagesResultOne: '{count} image was imported as a placeholder.',
    view: 'View imported',
    finish: 'Done',
