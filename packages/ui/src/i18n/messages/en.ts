...
export const en = {
  ...
  appearance: {
    ...
    interfaceTint: 'Interface tint',
    interfaceTintHint: 'Tint the neutral surfaces — warm, cool, plain gray, or matched to the accent.',
    neutralWarm: 'Warm',
    neutralCool: 'Cool',
    neutralGray: 'Gray',
    neutralMatch: 'Match',
    controlAccent: 'Control accent',
    controlAccentHint: 'How strongly buttons and rows shade on hover and when selected.',
    tintedSidebar: 'Tinted sidebar',
    tintedSidebarHint: 'Let the sidebar take on the accent color.',
    levelOff: 'Off',
    levelSubtle: 'Subtle',
    levelMedium: 'Medium',
    levelStrong: 'Strong',
