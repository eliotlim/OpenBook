...
export const en = {
  ...
  backup: {
    ...
    folderIntro: 'Save your library as a folder of readable .html files (one per page), or load one back. The folder round-trips losslessly.',
  ...
  connection: {
    ...
    bookFilesDescription: 'A readable folder of HTML pages, mirrored from your library for backup and external sync.',
    bookFolder: 'Folder',
    changeFolder: 'Change…',
  ...
  agents: {
    ...
    loadError: 'Could not load agent tokens.',
    ...
    killSwitchNote: 'The agent API is force-disabled by OPENBOOK_AGENT_API=0 on this server; clear that env to use it.',
