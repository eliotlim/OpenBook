...
export const en = {
  ...
  importer: {
    ...
    formats: 'Notion export (.zip) or Markdown (.md)',
    pasteToggle: 'Or paste Markdown instead',
    ...
    unsupported: 'Choose a Notion export (.zip) or a Markdown (.md) file.',
    empty: 'There’s nothing to import in that file.',
    emptyPaste: 'Paste some Markdown to import.',
