...
export const en = {
  ...
  database: {
    ...
    formView: {
      builder: 'Build',
      fill: 'Fill',
      builderIntro: 'Fields project the live database schema. Rename or change a column and this form updates automatically.',
      fields: 'Form fields',
      rowTitle: 'Row title',
      addField: 'Add field',
      ...
      reviewChoiceWarning: 'Select, status, and checkbox fields are publicly writable. Confirm their choices and meaning before publishing.',
