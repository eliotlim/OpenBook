...
export const ja: PartialMessages = {
  ...
  sharing: {
    ...
    accessPublished: '公開したページのみ',
    accessView: '誰でも閲覧できる',
    accessEdit: '誰でも編集できる',
    accessPrivateHint: 'このライブラリを開けるのはメンバーのみです。サインインしていない訪問者には何も表示されません。',
    accessPublishedHint: '明示的に公開したページだけが訪問者に表示されます。それ以外はプライベートのままです。',
    accessViewHint: '訪問者はサインインせずにこのライブラリのすべてのページを読めますが、変更はできません。',
    accessEditHint: '訪問者はサインインせずにこのライブラリのすべてのページを読み、変更できます。',
