...
export const ja: PartialMessages = {
  ...
  share: {
    ...
    enforcementCaveat:
      '招待した人は、公開された book.pub リンクからこのページをまだ開けない場合があります — 現在順次対応中です。直接アクセスはここで設定したとおりすでに制限されています。',
    scopeLabel: 'アクセスできる人',
    scope: {
      inherit: 'ワークスペースの既定',
  ...
  sharing: {
    ...
    guestAccess: 'ゲストアクセス',
    guestAccessHint: 'サインインせずにこのワークスペースへ到達するすべての人に適用されます — ネットワーク経由や共有 ✦.book.pub リンクなど。',
    guestWrite: '閲覧と編集',
    guestRead: '閲覧のみ',
    guestOff: 'アクセスなし',
  ...
  forwarding: {
    ...
    title: 'ウェブに転送',
    description:
      'プライベートな ✦.book.pub アドレスを取得すると、このデバイスのブックをどのブラウザーからでも開けます。ホスティングもネットワークでの公開も不要です。',
    toggle: 'このデバイスを転送',
