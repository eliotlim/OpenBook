...
export const ja: PartialMessages = {
  ...
  share: {
    ...
    siteRestrictedNotice:
      'このページは「リンクを知っている全員」に設定されていますが、公開アドレスが「非公開」のため、サインインしていない人は開けません。アドレスを「公開」にすると、リンクを知っている全員が開けるようになります。',
    makeSitePublic: 'アドレスを公開にする',
    siteGlobalHint: 'この設定はこのページだけでなく、公開アドレス全体に適用されます。',
    scopeLabel: 'アクセスできる人',
  ...
  forwarding: {
    ...
    visibility: {
      ...
      authenticatedHint: 'サインインしている人なら誰でもこのアドレスを開けます。',
      membersHint: 'ワークスペースのメンバーがこのアドレスを開けます。',
      manageOnWeb: 'ウェブで管理',
