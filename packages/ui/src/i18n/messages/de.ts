...
export const de: PartialMessages = {
  ...
  sharing: {
    ...
    guestAccessHint: 'Gilt für alle, die diese Bibliothek ohne Anmeldung erreichen — über das Netzwerk oder einen geteilten ✦.book.cloud-Link.',
  ...
  forwarding: {
    ...
    visibility: {
      ...
      privateHint: 'Nur Mitglieder und Gäste der Bibliothek können diese Bibliothek sehen.',
