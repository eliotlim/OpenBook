...
export const zh: PartialMessages = {
  ...
  sharing: {
    ...
    accessPublished: '仅已发布的页面',
    accessView: '任何人可查看',
    accessEdit: '任何人可编辑',
    accessPrivateHint: '只有成员可以打开此资料库。未登录的访客什么都看不到。',
    accessPublishedHint: '只有你明确发布的页面对访客可见，其他内容仍保持私密。',
    accessViewHint: '访客无需登录即可阅读此资料库的每一个页面，但无法进行修改。',
    accessEditHint: '访客无需登录即可阅读并修改此资料库的每一个页面。',
  ...
  forwarding: {
    ...
    visibility: {
      ...
      guestOffCaveat:
        '访客访问已关闭，因此已发布页面仍无法向未登录的访客打开。请在资料库的共享设置中开启访客查看。',
      manageOnWeb: '在网页端管理',
      error: '无法更新地址访问。请重试。',
    },
  },
